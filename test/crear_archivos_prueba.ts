...
const bufferAcudientes = XLSX.write(wbAcudientes, { type: 'buffer', bookType: 'xlsx' })
writeFileSync(join(__dirname, 'ejemplo_acudientes.xlsx'), bufferAcudientes)
...
const bufferEstudiantes = XLSX.write(wbEstudiantes, { type: 'buffer', bookType: 'xlsx' })
writeFileSync(join(__dirname, 'ejemplo_estudiantes.xlsx'), bufferEstudiantes)
