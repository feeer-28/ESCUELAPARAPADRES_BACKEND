...
// Catálogos para formulario de creación (debe ir antes de /:id)

router.get('/instituciones/catalogos', [InstitucionController, 'catalogos'])

router.get('/instituciones/:id', [InstitucionController, 'show'])

// Ruta especial para creación completa (debe ir después de /:id para no conflictuar)
router.post('/instituciones/completa', [InstitucionController, 'storeCompleto'])
